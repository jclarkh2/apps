...
param(
  ...
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('Broad', 'Targeted', 'Monthly')]$Channel = 'Monthly',
  [Parameter(ParameterSetName = 'NoXML')][Switch]$DisplayInstall = $True,
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('Groove', 'OneNote', 'Access', 'OneDrive', 'Publisher', 'Word', 'Excel', 'PowerPoint', 'Teams', 'Lync')][Array]$ExcludeApps,
  ...
  [Parameter(ParameterSetName = 'NoXML')][ValidateSet('TRUE', 'FALSE')]$PinItemsToTaskbar = 'FALSE',
